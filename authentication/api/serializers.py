...
from authentication.models import Categorie, FavoriteCategorie
...
class LoginSerializer(serializers.ModelSerializer):  
    ...
    def validate_username(self,username,password):  
        ...
        if user is None : #try with email
            ...
            print(user)
        if user is None :
            raise serializers.ValidationError("Impossible de se connecter avec les informations d'identification fournies.")
